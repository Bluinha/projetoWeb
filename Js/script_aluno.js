...
// --- 3. Função para abrir formulário de cadastro ---
...
// Objeto global para armazenar o mapeamento de nome para ID
    ...
    // Função para habilitar a edição do nome de uma vaca.
    ...
    // Função para salvar o nome editado da vaca.
    ...
    // Função para filtrar a tabela de produção de leite.
    ...
    // Função para habilitar a edição de um registro de produção de leite.
    ...
    // Função para salvar a edição de um registro de produção.
    ...
    // Função para filtrar a tabela de testes de mastite.
    ...
    // Função para habilitar a edição de um registro de teste de mastite.
    ...
    // Função para excluir um registro de teste de mastite.
